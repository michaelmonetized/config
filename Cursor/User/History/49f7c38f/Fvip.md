...
### 🐛 Fixed Convex schema validation error

- Made `created` field optional in ContactTable for legacy data compatibility
- Existing contacts without `created` field no longer cause schema validation failures
